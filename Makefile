...
ifndef NODE
	...
	@echo '{"apiVersion":"lifecycle.k8s.io/v1alpha1","kind":"LifecycleEvent","metadata":{"name":"drain-$(NODE)"},"spec":{"transitionName":"kssd-drain","bindingNode":"$(NODE)"}}' | kubectl apply -f -
...
ifndef NODE
	...
	@echo '{"apiVersion":"lifecycle.k8s.io/v1alpha1","kind":"LifecycleEvent","metadata":{"name":"uncordon-$(NODE)"},"spec":{"transitionName":"kssd-maintenance-complete","bindingNode":"$(NODE)"}}' | kubectl apply -f -

.PHONY: clean
clean: ## Delete the LifecycleTransitions created by this driver.
	kubectl delete lifecycletransition kssd-drain --ignore-not-found
	kubectl delete lifecycletransition kssd-maintenance-complete --ignore-not-found
